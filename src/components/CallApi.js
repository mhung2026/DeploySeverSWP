...
class CallApi {
    ...
    static async getAllPayMent() {
        try {
            const response = await axios.get('https://script.googleusercontent.com/macros/echo?user_content_key=dYJzuHUzfYMmr4JS1QdApKTWUqExcLTHEcb8ErGg1L-T4q8msa93RMojITN-On8CPqcD7qfjquU36395ig0Ekk8MZ9CXGSR5m5_BxDlH2jW0nuo2oDemN9CCS2h10ox_1xSncGQajx_ryfhECjZEnGjZ6hU-hlPbYlHOK9fGLai_cu_rRwEO_TPTYCkBfRzM6XmyaWKQdVo6ORSpwbzUjMqqzP7LEnZje-seCYvZUgTKincyOlPDZdz9Jw9Md8uu&lib=MGCO5stwzZB-iQdX_zubzKc5RV3tBGefZ');
            return response.data;
        } catch (error) {
            console.error('Error fetching real estate data:', error);
            return null;
